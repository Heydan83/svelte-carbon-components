<script>
  ...
  // Components
  import Modal from "./modal/ModalTrigger.svelte";

  export let selectionFromModal = null;
</script>

<div class="bx--form-item">
  <label for="text-input-3" class="bx--label">Text Input label</label>
  <div class="bx--form__helper-text">
    Optional helper text here; if message is more than one line text should wrap
    ...
    <div class="bx--select-input__wrapper">
      <select id="select-id" class="bx--select-input ">
        ...
        <option class="bx--select-option" value="solong">
          A much longer option that is worth having around to check how text
          flows
        </option>
...
<div>
  <Modal bind:selectedOption={selectionFromModal} {...modalConfig} />
</div>
